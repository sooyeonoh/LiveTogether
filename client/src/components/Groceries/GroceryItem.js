...
const GroceryItem = (props) => (
        <Card className="border-0 m-2 p-1 pt-4" style={{ width: '180px', boxShadow: '1px 1px 5px rgba(0, 0, 0, .15)'}}>
            <Card.Img className="m-auto" style={{ width: '75px', height: 'auto' }} variant="top" src={"https://spoonacular.com/cdn/ingredients_100x100/"+ props.groceryItem.image} />
            <CancelIcon className="position-absolute" style={{top: '0', right: '0', margin: '10px 10px 0 0', color: 'lightgray'}}/>
                <Card.Body>
